    ...
    <form id="form1" runat="server" style="height: 100%">
        <div id="silverlightControlHost">
            <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%" style="float: left;">
                ...
                <param name="source" value="ClientBin/DebugCoverSUI.xap" />
                ...
                <a href="install/Silverlight_x64.exe" style="text-decoration: none">
                    <img src="install/SilverlightInstall.png" alt="Microsoft Silverlight 얻기" style="border-style: none" />
                </a>
            </object>
