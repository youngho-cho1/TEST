...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_PartWashingComplete
    /// </summary>
    public partial class BR_BRS_REG_PartWashingComplete : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string WSGUID
            {
                ...
                set
                {
                    ...
                    {
                        this._WSGUID = value;
                        this.CheckIsOriginal("WSGUID", value);
            ...
            public string SIGNATUREGUID
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("SIGNATUREGUID", value);
                        this.OnPropertyChanged("SIGNATUREGUID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class INDETAILCollection : BufferedObservableCollection<INDETAIL>
        {
        }
        private INDETAILCollection _INDETAILs;
        [BizActorInputSetAttribute()]
        public INDETAILCollection INDETAILs
        {
            get
            {
                return this._INDETAILs;
            }
        }
        [BizActorInputSetDefineAttribute(Order = "1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class INDETAIL : BizActorDataSetBase
        {
            public INDETAIL()
            {
                RowLoadedFlag = false;
            ...
            public string TOOLID
            {
                ...
                set
                {
                    ...
                    {
                        this._TOOLID = value;
                        this.CheckIsOriginal("TOOLID", value);
        ...
        public sealed partial class HISTDATACollection : BufferedObservableCollection<HISTDATA>
        {
        }
        private HISTDATACollection _HISTDATAs;
        [BizActorOutputSetAttribute()]
        public HISTDATACollection HISTDATAs
        {
            get
            {
                return this._HISTDATAs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order = "0")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class HISTDATA : BizActorDataSetBase
        {
            public HISTDATA()
            {
                RowLoadedFlag = false;
        ...
        public BR_BRS_REG_PartWashingComplete()
        {
            RuleName = "BR_BRS_REG_PartWashingComplete";
            _INDATAs = new INDATACollection();
            _INDETAILs = new INDETAILCollection();
            _HISTDATAs = new HISTDATACollection();
        }
    }
}
