...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_PartWashingDetail
    /// </summary>
    public partial class BR_BRS_SEL_PartWashingDetail : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string TOOLNAME
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("TOOLNAME", value);
            ...
            public System.Nullable<System.DateTime> USEDDTTM
            {
                ...
                set
                {
                    ...
                    {
                        this._USEDDTTM = value;
                        this.CheckIsOriginal("USEDDTTM", value);
                        this.OnPropertyChanged("USEDDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _EQSHID;
            [BizActorOutputItemAttribute()]
            public string EQSHID
            {
                get
                {
                    return this._EQSHID;
                ...
                set
                {
                    ...
                    {
                        this._EQSHID = value;
                        this.CheckIsOriginal("EQSHID", value);
                        this.OnPropertyChanged("EQSHID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _NEW_WSGUID;
            [BizActorOutputItemAttribute()]
            public string NEW_WSGUID
            {
                get
                {
                    return this._NEW_WSGUID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._NEW_WSGUID = value;
                        this.CheckIsOriginal("NEW_WSGUID", value);
                        this.OnPropertyChanged("NEW_WSGUID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public System.Nullable<int> PRIORITY
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PRIORITY", value);
        ...
        public BR_BRS_SEL_PartWashingDetail()
        {
            RuleName = "BR_BRS_SEL_PartWashingDetail";
