...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderVesselInfo
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderVesselInfo : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _FROMDTTM;
            [BizActorInputItemAttribute()]
            public string FROMDTTM
            {
                get
                {
            ...
            public string POSTAT
            {
                ...
                set
                {
                    ...
                    {
                        this._POSTAT = value;
                        this.CheckIsOriginal("POSTAT", value);
                        this.OnPropertyChanged("POSTAT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderVesselInfo()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderVesselInfo";
