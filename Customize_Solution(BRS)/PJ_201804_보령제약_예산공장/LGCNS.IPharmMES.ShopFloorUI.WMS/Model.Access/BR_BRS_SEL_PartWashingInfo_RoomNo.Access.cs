...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_PartWashingInfo_RoomNo
    /// </summary>
    public partial class BR_BRS_SEL_PartWashingInfo_RoomNo : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _PARENTEQPTID;
            [BizActorOutputItemAttribute()]
            public string PARENTEQPTID
            {
                get
                {
                    return this._PARENTEQPTID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PARENTEQPTID = value;
                        this.CheckIsOriginal("PARENTEQPTID", value);
                        this.OnPropertyChanged("PARENTEQPTID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_PartWashingInfo_RoomNo()
        {
            RuleName = "BR_BRS_SEL_PartWashingInfo_RoomNo";
