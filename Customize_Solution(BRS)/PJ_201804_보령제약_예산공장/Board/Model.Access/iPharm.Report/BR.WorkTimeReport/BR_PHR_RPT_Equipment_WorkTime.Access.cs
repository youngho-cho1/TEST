...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_PHR_RPT_Equipment_WorkTime
    /// </summary>
    public partial class BR_PHR_RPT_Equipment_WorkTime : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string PRODDATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PRODDATE", value);
                        this.OnPropertyChanged("PRODDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PRODSTDDTTM;
            [BizActorOutputItemAttribute()]
            public string PRODSTDDTTM
            {
                get
                {
                    return this._PRODSTDDTTM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PRODSTDDTTM = value;
                        this.CheckIsOriginal("PRODSTDDTTM", value);
                        this.OnPropertyChanged("PRODSTDDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PRODEDDTTM;
            [BizActorOutputItemAttribute()]
            public string PRODEDDTTM
            {
                get
                {
                    return this._PRODEDDTTM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PRODEDDTTM = value;
                        this.CheckIsOriginal("PRODEDDTTM", value);
                        this.OnPropertyChanged("PRODEDDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _WORKTIME_MIN;
            [BizActorOutputItemAttribute()]
            public string WORKTIME_MIN
            {
                get
                {
                    return this._WORKTIME_MIN;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WORKTIME_MIN = value;
                        this.CheckIsOriginal("WORKTIME_MIN", value);
                        this.OnPropertyChanged("WORKTIME_MIN");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _WORKTIME_HOUR;
            [BizActorOutputItemAttribute()]
            public string WORKTIME_HOUR
            {
                get
                {
                    return this._WORKTIME_HOUR;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WORKTIME_HOUR = value;
                        this.CheckIsOriginal("WORKTIME_HOUR", value);
                        this.OnPropertyChanged("WORKTIME_HOUR");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _FAIRRQTY;
            [BizActorOutputItemAttribute()]
            public string FAIRRQTY
            {
                get
                {
                    return this._FAIRRQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FAIRRQTY = value;
                        this.CheckIsOriginal("FAIRRQTY", value);
                        this.OnPropertyChanged("FAIRRQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _FAULTQTY;
            [BizActorOutputItemAttribute()]
            public string FAULTQTY
            {
                get
                {
                    return this._FAULTQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FAULTQTY = value;
                        this.CheckIsOriginal("FAULTQTY", value);
                        this.OnPropertyChanged("FAULTQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_PHR_RPT_Equipment_WorkTime()
        {
            RuleName = "BR_PHR_RPT_Equipment_WorkTime";
