...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_PHR_RPT_Employee_WorkTime_by_EmpNo
    /// </summary>
    public partial class BR_PHR_RPT_Employee_WorkTime_by_EmpNo : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _WORKSTDATE;
            [BizActorOutputItemAttribute()]
            public string WORKSTDATE
            {
                get
                {
                    return this._WORKSTDATE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WORKSTDATE = value;
                        this.CheckIsOriginal("WORKSTDATE", value);
                        this.OnPropertyChanged("WORKSTDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _WORKEDDATE;
            [BizActorOutputItemAttribute()]
            public string WORKEDDATE
            {
                get
                {
                    return this._WORKEDDATE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WORKEDDATE = value;
                        this.CheckIsOriginal("WORKEDDATE", value);
                        this.OnPropertyChanged("WORKEDDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_PHR_RPT_Employee_WorkTime_by_EmpNo()
        {
            RuleName = "BR_PHR_RPT_Employee_WorkTime_by_EmpNo";
