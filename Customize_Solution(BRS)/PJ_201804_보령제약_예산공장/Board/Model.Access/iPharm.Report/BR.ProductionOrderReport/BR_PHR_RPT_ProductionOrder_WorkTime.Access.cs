...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_PHR_RPT_ProductionOrder_WorkTime
    /// </summary>
    public partial class BR_PHR_RPT_ProductionOrder_WorkTime : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _TOTAL_MAN;
            [BizActorOutputItemAttribute()]
            public string TOTAL_MAN
            {
                get
                {
                    return this._TOTAL_MAN;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._TOTAL_MAN = value;
                        this.CheckIsOriginal("TOTAL_MAN", value);
                        this.OnPropertyChanged("TOTAL_MAN");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_PHR_RPT_ProductionOrder_WorkTime()
        {
            RuleName = "BR_PHR_RPT_ProductionOrder_WorkTime";
