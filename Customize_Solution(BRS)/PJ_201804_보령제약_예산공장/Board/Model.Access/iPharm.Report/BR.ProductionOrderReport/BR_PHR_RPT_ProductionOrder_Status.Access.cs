...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// </summary>
    public partial class BR_PHR_RPT_ProductionOrder_Status : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _PLANSTDATE;
            [BizActorOutputItemAttribute()]
            public string PLANSTDATE
            {
                get
                {
                    return this._PLANSTDATE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PLANSTDATE = value;
                        this.CheckIsOriginal("PLANSTDATE", value);
                        this.OnPropertyChanged("PLANSTDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string PLANEDDATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PLANEDDATE", value);
                        this.OnPropertyChanged("PLANEDDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string CREATEDATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("CREATEDATE", value);
            ...
            public string RELEASEDATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RELEASEDATE", value);
            ...
            public string REVIEWDATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("REVIEWDATE", value);
            ...
            public string APPRDATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("APPRDATE", value);
                        this.OnPropertyChanged("APPRDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string INSPDATE
            {
                ...
                set
                {
                    ...
                    {
                        this._INSPDATE = value;
                        this.CheckIsOriginal("INSPDATE", value);
                        this.OnPropertyChanged("INSPDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
