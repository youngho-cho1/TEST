...
namespace Board
{
    public class ManufacturingPerformanceViewModel : ViewModelBase
    {
        #region property

        private ManufacturingPerformanceView _mainWnd;
                    ...
                    using (await AwaitableLocks["LoadedCommand"].EnterAsync())
                    {
                        try
                        {
                            ...
                            if (arg == null || !(arg is ManufacturingPerformanceView))
                                return;
                            _mainWnd = arg as ManufacturingPerformanceView;
        ...
        public ManufacturingPerformanceViewModel()
        {
