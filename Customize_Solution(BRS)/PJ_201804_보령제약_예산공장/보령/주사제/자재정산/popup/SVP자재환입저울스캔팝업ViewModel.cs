...
namespace 보령
{
    public class SVP자재환입저울스캔팝업ViewModel : ViewModelBase
    {
        private SVP자재환입저울스캔팝업 _mainWnd;
        ...
        SVP자재환입처리ViewModel _ParentVM;
        public SVP자재환입처리ViewModel ParentVM
        {
            ...
            get
            {
                return new CommandBase(arg =>
                {
                    try
                    {
                        ...
                        if (arg != null && arg is SVP자재환입저울스캔팝업)
                            _mainWnd = arg as SVP자재환입저울스캔팝업;
        ...
        public SVP자재환입저울스캔팝업ViewModel(Enum strScanType)
        {
