...
namespace 보령
{
    public class 장비이력데이터V2ViewModel : ViewModelBase
    {
                ...
                return new AsyncCommandBase(async arg =>
                {
                    using (await AwaitableLocks["ConfirmCommand"].EnterAsync())
                    {
                        try
                        {
                            ...
                            Brush oldBorderBrush = _mainWnd.PrintArea.BorderBrush;
                            Thickness oldBorderThickness = _mainWnd.PrintArea.BorderThickness;
                            Brush oldBackground = _mainWnd.PrintArea.Background;
                            ...
                            _mainWnd.PrintArea.BorderBrush = oldBorderBrush;
                            _mainWnd.PrintArea.BorderThickness = oldBorderThickness;
                            _mainWnd.PrintArea.Background = oldBackground;
                            ...
                            #region 그래프 갭쳐 시간 저장 Remark(2022.03.11 진백승, 보령 요청)
        ...
        async Task GetValues(DateTime fromDT, DateTime toDT, string EQPTID)
        {
            ...
            SelectedFromDt = DateTime.FromOADate(fromDt).ToString("yyyy-MM-dd HH:mm:ss");
            SelectedToDt = DateTime.FromOADate(toDt).ToString("yyyy-MM-dd HH:mm:ss");
