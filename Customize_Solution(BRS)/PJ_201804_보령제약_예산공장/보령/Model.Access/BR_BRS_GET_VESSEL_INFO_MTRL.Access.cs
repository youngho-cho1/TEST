...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_VESSEL_INFO_MTRL
    /// </summary>
    public partial class BR_BRS_GET_VESSEL_INFO_MTRL : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<decimal> _OUTPUTQTY;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> OUTPUTQTY
            {
                get
                {
            ...
            private string _OUTPUTQTYSTR;
            [BizActorOutputItemAttribute()]
            public string OUTPUTQTYSTR
            {
                get
                {
                    return this._OUTPUTQTYSTR;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._OUTPUTQTYSTR = value;
                        this.CheckIsOriginal("OUTPUTQTYSTR", value);
                        this.OnPropertyChanged("OUTPUTQTYSTR");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_GET_VESSEL_INFO_MTRL()
        {
            RuleName = "BR_BRS_GET_VESSEL_INFO_MTRL";
