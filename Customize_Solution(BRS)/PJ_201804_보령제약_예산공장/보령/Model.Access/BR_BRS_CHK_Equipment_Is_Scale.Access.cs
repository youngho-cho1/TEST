...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_CHK_Equipment_Is_Scale
    /// </summary>
    public partial class BR_BRS_CHK_Equipment_Is_Scale : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _ISPROPER;
            [BizActorOutputItemAttribute()]
            public string ISPROPER
            {
                get
                {
                    return this._ISPROPER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ISPROPER", value);
                        this.OnPropertyChanged("ISPROPER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_CHK_Equipment_Is_Scale()
        {
            RuleName = "BR_BRS_CHK_Equipment_Is_Scale";
