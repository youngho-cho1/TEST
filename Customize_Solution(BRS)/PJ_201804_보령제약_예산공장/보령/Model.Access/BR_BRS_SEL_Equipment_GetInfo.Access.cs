...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_Equipment_GetInfo
    /// </summary>
    public partial class BR_BRS_SEL_Equipment_GetInfo : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _EQPTDESC;
            [BizActorOutputItemAttribute()]
            public string EQPTDESC
            {
                get
                {
                    return this._EQPTDESC;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQPTDESC = value;
                        this.CheckIsOriginal("EQPTDESC", value);
                        this.OnPropertyChanged("EQPTDESC");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PARENTEQPTNAME;
            [BizActorOutputItemAttribute()]
            public string PARENTEQPTNAME
            {
                get
                {
                    return this._PARENTEQPTNAME;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PARENTEQPTNAME = value;
                        this.CheckIsOriginal("PARENTEQPTNAME", value);
                        this.OnPropertyChanged("PARENTEQPTNAME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string ISSTORAGE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ISSTORAGE", value);
                        this.OnPropertyChanged("ISSTORAGE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string ISTRACKING
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ISTRACKING", value);
                        this.OnPropertyChanged("ISTRACKING");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string ISTRANSFER
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ISTRANSFER", value);
                        this.OnPropertyChanged("ISTRANSFER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _CLEANCLASS;
            [BizActorOutputItemAttribute()]
            public string CLEANCLASS
            {
                get
                {
                    return this._CLEANCLASS;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._CLEANCLASS = value;
                        this.CheckIsOriginal("CLEANCLASS", value);
                        this.OnPropertyChanged("CLEANCLASS");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string EQCLNAME
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("EQCLNAME", value);
            ...
            private string _PARENTEQCLID;
            [BizActorOutputItemAttribute()]
            public string PARENTEQCLID
            {
                get
                {
                    return this._PARENTEQCLID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PARENTEQCLID = value;
                        this.CheckIsOriginal("PARENTEQCLID", value);
                        this.OnPropertyChanged("PARENTEQCLID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PARENTEQCLNAME;
            [BizActorOutputItemAttribute()]
            public string PARENTEQCLNAME
            {
                get
                {
                    return this._PARENTEQCLNAME;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PARENTEQCLNAME = value;
                        this.CheckIsOriginal("PARENTEQCLNAME", value);
                        this.OnPropertyChanged("PARENTEQCLNAME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_Equipment_GetInfo()
        {
            RuleName = "BR_BRS_SEL_Equipment_GetInfo";
