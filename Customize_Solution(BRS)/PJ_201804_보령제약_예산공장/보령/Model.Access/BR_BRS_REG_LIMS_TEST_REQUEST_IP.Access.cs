...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_LIMS_TEST_REQUEST_IP
    /// </summary>
    public partial class BR_BRS_REG_LIMS_TEST_REQUEST_IP : BizActorRuleBase
    {
        ...
        public BR_BRS_REG_LIMS_TEST_REQUEST_IP()
        {
            RuleName = "BR_BRS_REG_LIMS_TEST_REQUEST_IP";
            BizName = "공정 중 시험의뢰 정보 저장";
