...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_WMS_S_MATERIALRETURN_MULTI
    /// </summary>
    public partial class BR_BRS_REG_WMS_S_MATERIALRETURN_MULTI : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<decimal> _RETURNQTY;
            [BizActorInputItemAttribute()]
            public System.Nullable<decimal> RETURNQTY
            {
                get
                {
            ...
            private string _RTN_NOTE;
            [BizActorInputItemAttribute()]
            public string RTN_NOTE
            {
                get
                {
                    return this._RTN_NOTE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._RTN_NOTE = value;
                        this.CheckIsOriginal("RTN_NOTE", value);
                        this.OnPropertyChanged("RTN_NOTE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_WMS_S_MATERIALRETURN_MULTI()
        {
            RuleName = "BR_BRS_REG_WMS_S_MATERIALRETURN_MULTI";
