...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderBOM_CHGSEQ_NonWeighing
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderBOM_CHGSEQ_NonWeighing : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string DSP
            {
                ...
                set
                {
                    ...
                    {
                        this._DSP = value;
                        this.CheckIsOriginal("DSP", value);
                        this.OnPropertyChanged("DSP");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string ISAVAIL
            {
                ...
                set
                {
                    ...
                    {
                        this._ISAVAIL = value;
                        this.CheckIsOriginal("ISAVAIL", value);
                        this.OnPropertyChanged("ISAVAIL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _SCANNED_MSUBLOTBCD;
            [BizActorOutputItemAttribute()]
            public string SCANNED_MSUBLOTBCD
            {
                get
                {
                    return this._SCANNED_MSUBLOTBCD;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._SCANNED_MSUBLOTBCD = value;
                        this.CheckIsOriginal("SCANNED_MSUBLOTBCD", value);
                        this.OnPropertyChanged("SCANNED_MSUBLOTBCD");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string REMAIN
            {
                ...
                set
                {
                    ...
                    {
                        this._REMAIN = value;
                        this.CheckIsOriginal("REMAIN", value);
            ...
            public string COMPLETEFLAG
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("COMPLETEFLAG", value);
                        this.OnPropertyChanged("COMPLETEFLAG");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderBOM_CHGSEQ_NonWeighing()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderBOM_CHGSEQ_NonWeighing";
