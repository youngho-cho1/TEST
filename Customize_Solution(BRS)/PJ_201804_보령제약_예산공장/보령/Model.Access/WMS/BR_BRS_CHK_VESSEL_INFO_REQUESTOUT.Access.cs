...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_CHK_VESSEL_INFO_REQUESTOUT
    /// </summary>
    public partial class BR_BRS_CHK_VESSEL_INFO_REQUESTOUT : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string PRODDTTM
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PRODDTTM", value);
            ...
            private string _VESSEL_DESC;
            [BizActorOutputItemAttribute()]
            public string VESSEL_DESC
            {
                get
                {
                    return this._VESSEL_DESC;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._VESSEL_DESC = value;
                        this.CheckIsOriginal("VESSEL_DESC", value);
                        this.OnPropertyChanged("VESSEL_DESC");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_CHK_VESSEL_INFO_REQUESTOUT()
        {
            RuleName = "BR_BRS_CHK_VESSEL_INFO_REQUESTOUT";
