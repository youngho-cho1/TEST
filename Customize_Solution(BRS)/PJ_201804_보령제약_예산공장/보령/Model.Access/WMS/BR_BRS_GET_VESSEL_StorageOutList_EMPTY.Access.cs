...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_VESSEL_StorageOutList_EMPTY
    /// </summary>
    public partial class BR_BRS_GET_VESSEL_StorageOutList_EMPTY : BizActorRuleBase
    {
            ...
            public string WASHINGDTTM
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("WASHINGDTTM", value);
        ...
        public BR_BRS_GET_VESSEL_StorageOutList_EMPTY()
        {
            RuleName = "BR_BRS_GET_VESSEL_StorageOutList_EMPTY";
