...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_FILTERINFO
    /// </summary>
    public partial class BR_BRS_GET_FILTERINFO : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _CHANGEDTTM;
            [BizActorOutputItemAttribute()]
            public string CHANGEDTTM
            {
                get
                {
                    return this._CHANGEDTTM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._CHANGEDTTM = value;
                        this.CheckIsOriginal("CHANGEDTTM", value);
                        this.OnPropertyChanged("CHANGEDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_GET_FILTERINFO()
        {
            RuleName = "BR_BRS_GET_FILTERINFO";
