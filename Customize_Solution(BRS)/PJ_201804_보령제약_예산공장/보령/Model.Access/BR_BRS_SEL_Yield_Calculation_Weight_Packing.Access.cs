...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_Yield_Calculation_Weight_Packing
    /// </summary>
    public partial class BR_BRS_SEL_Yield_Calculation_Weight_Packing : BizActorRuleBase
    {
        ...
        public sealed partial class OUTDATA1Collection : BufferedObservableCollection<OUTDATA1>
        {
        }
        private OUTDATA1Collection _OUTDATA1s;
        [BizActorOutputSetAttribute()]
        public OUTDATA1Collection OUTDATA1s
        {
            get
            {
                return this._OUTDATA1s;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="0")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class OUTDATA1 : BizActorDataSetBase
        {
            public OUTDATA1()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class OUTDATA2Collection : BufferedObservableCollection<OUTDATA2>
        {
        }
        private OUTDATA2Collection _OUTDATA2s;
        [BizActorOutputSetAttribute()]
        public OUTDATA2Collection OUTDATA2s
        {
            get
            {
                return this._OUTDATA2s;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class OUTDATA2 : BizActorDataSetBase
        {
            public OUTDATA2()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class OUTDATA3Collection : BufferedObservableCollection<OUTDATA3>
        {
        }
        private OUTDATA3Collection _OUTDATA3s;
        [BizActorOutputSetAttribute()]
        public OUTDATA3Collection OUTDATA3s
        {
            get
            {
                return this._OUTDATA3s;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="2")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class OUTDATA3 : BizActorDataSetBase
        {
            public OUTDATA3()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class OUTDATA4Collection : BufferedObservableCollection<OUTDATA4>
        {
        }
        private OUTDATA4Collection _OUTDATA4s;
        [BizActorOutputSetAttribute()]
        public OUTDATA4Collection OUTDATA4s
        {
            get
            {
                return this._OUTDATA4s;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="3")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class OUTDATA4 : BizActorDataSetBase
        {
            public OUTDATA4()
            {
                RowLoadedFlag = false;
        ...
        public BR_BRS_SEL_Yield_Calculation_Weight_Packing()
        {
            RuleName = "BR_BRS_SEL_Yield_Calculation_Weight_Packing";
            BizName = "BR_BRS_SEL_Yield_Calculation_Weight_Packing";
            _INDATAs = new INDATACollection();
            _OUTDATA1s = new OUTDATA1Collection();
            _OUTDATA2s = new OUTDATA2Collection();
            _OUTDATA3s = new OUTDATA3Collection();
            _OUTDATA4s = new OUTDATA4Collection();
        }
    }
}
