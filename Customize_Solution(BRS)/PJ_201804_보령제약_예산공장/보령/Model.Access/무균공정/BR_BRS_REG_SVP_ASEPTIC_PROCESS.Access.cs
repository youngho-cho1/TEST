...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// </summary>
    public partial class BR_BRS_REG_SVP_ASEPTIC_PROCESS : BizActorRuleBase
    {
            ...
            public string TARGETVAL
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("TARGETVAL", value);
                        this.OnPropertyChanged("TARGETVAL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_SVP_ASEPTIC_PROCESS()
        {
