...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_ProductionOrderOutput_Conditional
    /// </summary>
    public partial class BR_BRS_REG_ProductionOrderOutput_Conditional : BizActorRuleBase
    {
        ...
        public sealed partial class LABEL_ParameterCollection : BufferedObservableCollection<LABEL_Parameter>
        {
        }
        private LABEL_ParameterCollection _LABEL_Parameters;
        [BizActorInputSetAttribute()]
        public LABEL_ParameterCollection LABEL_Parameters
        {
            get
            {
                return this._LABEL_Parameters;
            }
        }
        ...
        public BR_BRS_REG_ProductionOrderOutput_Conditional()
        {
            RuleName = "BR_BRS_REG_ProductionOrderOutput_Conditional";
            _INDATAs = new INDATACollection();
            _LABEL_INDATAs = new LABEL_INDATACollection();
            _LABEL_Parameters = new LABEL_ParameterCollection();
