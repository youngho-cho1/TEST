...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_EquipmentStatusParameter_EQSTID
    /// </summary>
    public partial class BR_BRS_SEL_EquipmentStatusParameter_EQSTID : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _ISONPARAMETER;
            [BizActorOutputItemAttribute()]
            public string ISONPARAMETER
            {
                get
                {
                    return this._ISONPARAMETER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._ISONPARAMETER = value;
                        this.CheckIsOriginal("ISONPARAMETER", value);
                        this.OnPropertyChanged("ISONPARAMETER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<int> _EQSPSEQ;
            [BizActorOutputItemAttribute()]
            public System.Nullable<int> EQSPSEQ
            {
                get
                {
                    return this._EQSPSEQ;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQSPSEQ = value;
                        this.CheckIsOriginal("EQSPSEQ", value);
                        this.OnPropertyChanged("EQSPSEQ");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _EQSPVAL;
            [BizActorOutputItemAttribute()]
            public string EQSPVAL
            {
                get
                {
                    return this._EQSPVAL;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQSPVAL = value;
                        this.CheckIsOriginal("EQSPVAL", value);
                        this.OnPropertyChanged("EQSPVAL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_EquipmentStatusParameter_EQSTID()
        {
            RuleName = "BR_BRS_SEL_EquipmentStatusParameter_EQSTID";
