...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_UDT_ProductionOrderAllocation_Info
    /// </summary>
    public partial class BR_BRS_SEL_UDT_ProductionOrderAllocation_Info : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string SUPPLIERID
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("SUPPLIERID", value);
            ...
            private System.Nullable<decimal> _SUPPLIERVER;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> SUPPLIERVER
            {
                get
                {
                    return this._SUPPLIERVER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._SUPPLIERVER = value;
                        this.CheckIsOriginal("SUPPLIERVER", value);
                        this.OnPropertyChanged("SUPPLIERVER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _MLOTTYPE;
            [BizActorOutputItemAttribute()]
            public string MLOTTYPE
            {
                get
                {
                    return this._MLOTTYPE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MLOTTYPE = value;
                        this.CheckIsOriginal("MLOTTYPE", value);
                        this.OnPropertyChanged("MLOTTYPE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_UDT_ProductionOrderAllocation_Info()
        {
            RuleName = "BR_BRS_SEL_UDT_ProductionOrderAllocation_Info";
