...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_EquipmentRecipeStepType
    /// </summary>
    public partial class BR_BRS_SEL_EquipmentRecipeStepType : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _ACTIVAL;
            [BizActorOutputItemAttribute()]
            public string ACTIVAL
            {
                get
                {
                    return this._ACTIVAL;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._ACTIVAL = value;
                        this.CheckIsOriginal("ACTIVAL", value);
                        this.OnPropertyChanged("ACTIVAL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string STEPNAME
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("STEPNAME", value);
        ...
        public BR_BRS_SEL_EquipmentRecipeStepType()
        {
            RuleName = "BR_BRS_SEL_EquipmentRecipeStepType";
            BizName = "";
