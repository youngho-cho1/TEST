...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_EquipmentRecipe_TAG_ACTVAL
    /// </summary>
    public partial class BR_BRS_SEL_EquipmentRecipe_TAG_ACTVAL : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string COLUMNNAME
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("COLUMNNAME", value);
            ...
            private System.Nullable<decimal> _COLUMNSEQ;
            [BizActorInputItemAttribute()]
            public System.Nullable<decimal> COLUMNSEQ
            {
                get
                {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("COLUMNSEQ", value);
                        this.OnPropertyChanged("COLUMNSEQ");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _ROWSEQ;
            [BizActorInputItemAttribute()]
            public System.Nullable<decimal> ROWSEQ
            {
                get
                {
                    return this._ROWSEQ;
                ...
                set
                {
                    ...
                    {
                        this._ROWSEQ = value;
                        this.CheckIsOriginal("ROWSEQ", value);
                        this.OnPropertyChanged("ROWSEQ");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_EquipmentRecipe_TAG_ACTVAL()
        {
            RuleName = "BR_BRS_SEL_EquipmentRecipe_TAG_ACTVAL";
            BizName = "BR_BRS_SEL_EquipmentRecipe_TAG_ACTVAL";
