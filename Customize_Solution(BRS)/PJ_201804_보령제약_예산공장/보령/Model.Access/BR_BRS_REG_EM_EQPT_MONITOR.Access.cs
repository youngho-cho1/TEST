...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_EM_EQPT_MONITOR
    /// </summary>
    public partial class BR_BRS_REG_EM_EQPT_MONITOR : BizActorRuleBase
    {
            ...
            public string RESULTMSG
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RESULTMSG", value);
                        this.OnPropertyChanged("RESULTMSG");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_EM_EQPT_MONITOR()
        {
            RuleName = "BR_BRS_REG_EM_EQPT_MONITOR";
