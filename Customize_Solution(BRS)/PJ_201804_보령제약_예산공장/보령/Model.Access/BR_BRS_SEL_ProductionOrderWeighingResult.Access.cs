...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderWeighingResult
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderWeighingResult : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _WMS_IF_FLAG;
            [BizActorOutputItemAttribute()]
            public string WMS_IF_FLAG
            {
                get
                {
                    return this._WMS_IF_FLAG;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WMS_IF_FLAG = value;
                        this.CheckIsOriginal("WMS_IF_FLAG", value);
                        this.OnPropertyChanged("WMS_IF_FLAG");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderWeighingResult()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderWeighingResult";
