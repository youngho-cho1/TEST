...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_PHR_SVP_UPD_EquipmentAction_Multi
    /// </summary>
    public partial class BR_PHR_SVP_UPD_EquipmentAction_Multi : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string USER
            {
                ...
                set
                {
                    ...
                    {
                        this._USER = value;
                        this.CheckIsOriginal("USER", value);
            ...
            private System.Nullable<System.DateTime> _DTTM;
            [BizActorInputItemAttribute()]
            public System.Nullable<System.DateTime> DTTM
            {
                get
                {
                    return this._DTTM;
                ...
                set
                {
                    ...
                    {
                        this._DTTM = value;
                        this.CheckIsOriginal("DTTM", value);
                        this.OnPropertyChanged("DTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _ISVIRTUALACTION;
            [BizActorInputItemAttribute()]
            public string ISVIRTUALACTION
            {
                get
                {
                    return this._ISVIRTUALACTION;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._ISVIRTUALACTION = value;
                        this.CheckIsOriginal("ISVIRTUALACTION", value);
                        this.OnPropertyChanged("ISVIRTUALACTION");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class STATUSDATACollection : BufferedObservableCollection<STATUSDATA>
        {
        }
        private STATUSDATACollection _STATUSDATAs;
        [BizActorInputSetAttribute()]
        public STATUSDATACollection STATUSDATAs
        {
            get
            {
                return this._STATUSDATAs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class STATUSDATA : BizActorDataSetBase
        {
            public STATUSDATA()
            {
                RowLoadedFlag = false;
            ...
            private string _NEWEXPIREPERIOD;
            [BizActorInputItemAttribute()]
            public string NEWEXPIREPERIOD
            {
                get
                {
                    return this._NEWEXPIREPERIOD;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._NEWEXPIREPERIOD = value;
                        this.CheckIsOriginal("NEWEXPIREPERIOD", value);
                        this.OnPropertyChanged("NEWEXPIREPERIOD");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class PARAMDATACollection : BufferedObservableCollection<PARAMDATA>
        {
        }
        private PARAMDATACollection _PARAMDATAs;
        [BizActorInputSetAttribute()]
        public PARAMDATACollection PARAMDATAs
        {
            get
            {
                return this._PARAMDATAs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="2")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class PARAMDATA : BizActorDataSetBase
        {
            public PARAMDATA()
            {
                RowLoadedFlag = false;
            ...
            public string PAVAL
            {
                ...
                set
                {
                    ...
                    {
                        this._PAVAL = value;
                        this.CheckIsOriginal("PAVAL", value);
                        this.OnPropertyChanged("PAVAL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_PHR_SVP_UPD_EquipmentAction_Multi()
        {
            RuleName = "BR_PHR_SVP_UPD_EquipmentAction_Multi";
            BizName = "BR_PHR_UPD_EquipmentAction_Multi";
            _INDATAs = new INDATACollection();
            _STATUSDATAs = new STATUSDATACollection();
            _PARAMDATAs = new PARAMDATACollection();
