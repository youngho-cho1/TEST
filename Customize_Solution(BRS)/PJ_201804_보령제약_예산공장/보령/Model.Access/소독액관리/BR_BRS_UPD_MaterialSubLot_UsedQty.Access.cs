...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_UPD_MaterialSubLot_UsedQty
    /// </summary>
    public partial class BR_BRS_UPD_MaterialSubLot_UsedQty : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<float> _USEDQTY;
            [BizActorInputItemAttribute()]
            public System.Nullable<float> USEDQTY
            {
                get
                {
                ...
                set
                {
                    ...
                    {
                        this._USEDQTY = value;
                        this.CheckIsOriginal("USEDQTY", value);
                        this.OnPropertyChanged("USEDQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_UPD_MaterialSubLot_UsedQty()
        {
            RuleName = "BR_BRS_UPD_MaterialSubLot_UsedQty";
