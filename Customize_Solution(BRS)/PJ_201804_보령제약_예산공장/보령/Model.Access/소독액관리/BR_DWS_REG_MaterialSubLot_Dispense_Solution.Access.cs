...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_DWS_REG_MaterialSubLot_Dispense_Solution
    /// </summary>
    public partial class BR_DWS_REG_MaterialSubLot_Dispense_Solution : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<short> _DISPENSECOUNT;
            [BizActorInputItemAttribute()]
            public System.Nullable<short> DISPENSECOUNT
            {
                get
                {
                    return this._DISPENSECOUNT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._DISPENSECOUNT = value;
                        this.CheckIsOriginal("DISPENSECOUNT", value);
                        this.OnPropertyChanged("DISPENSECOUNT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_DWS_REG_MaterialSubLot_Dispense_Solution()
        {
            RuleName = "BR_DWS_REG_MaterialSubLot_Dispense_Solution";
