...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_INSTPCTION_FAILQTY
    /// </summary>
    public partial class BR_BRS_REG_INSTPCTION_FAILQTY : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string FAILQTY
            {
                ...
                set
                {
                    ...
                    {
                        this._FAILQTY = value;
                        this.CheckIsOriginal("FAILQTY", value);
        ...
        public BR_BRS_REG_INSTPCTION_FAILQTY()
        {
            RuleName = "BR_BRS_REG_INSTPCTION_FAILQTY";
