...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_UPD_MaterialSubLot_ChangeQuantity
    /// </summary>
    public partial class BR_BRS_UPD_MaterialSubLot_ChangeQuantity : BizActorRuleBase
    {
        public sealed partial class INDATA_MLOTCollection : BufferedObservableCollection<INDATA_MLOT>
        {
        }
        private INDATA_MLOTCollection _INDATA_MLOTs;
        [BizActorInputSetAttribute()]
        public INDATA_MLOTCollection INDATA_MLOTs
        {
            get
            {
        ...
        public partial class INDATA_MLOT : BizActorDataSetBase
        {
            ...
            private string _INDUSER;
            [BizActorInputItemAttribute()]
            public string INDUSER
            {
                get
                {
                    return this._INDUSER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INDUSER = value;
                        this.CheckIsOriginal("INDUSER", value);
                        this.OnPropertyChanged("INDUSER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class INDATA_MSUBLOTCollection : BufferedObservableCollection<INDATA_MSUBLOT>
        {
        }
        private INDATA_MSUBLOTCollection _INDATA_MSUBLOTs;
        [BizActorInputSetAttribute()]
        public INDATA_MSUBLOTCollection INDATA_MSUBLOTs
        {
            get
            {
        ...
        public sealed partial class LABEL_INDATACollection : BufferedObservableCollection<LABEL_INDATA>
        {
        }
        private LABEL_INDATACollection _LABEL_INDATAs;
        [BizActorInputSetAttribute()]
        public LABEL_INDATACollection LABEL_INDATAs
        {
            get
            {
                return this._LABEL_INDATAs;
            }
        }
        ...
        public partial class LABEL_INDATA : BizActorDataSetBase
        {
            ...
            public string ReportPath
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ReportPath", value);
            ...
            public string PrintName
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PrintName", value);
                        this.OnPropertyChanged("PrintName");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<bool> _PRINTYN;
            [BizActorInputItemAttribute()]
            public System.Nullable<bool> PRINTYN
            {
                get
                {
                    return this._PRINTYN;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PRINTYN = value;
                        this.CheckIsOriginal("PRINTYN", value);
                        this.OnPropertyChanged("PRINTYN");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class LABEL_ParametersCollection : BufferedObservableCollection<LABEL_Parameters>
        {
        }
        private LABEL_ParametersCollection _LABEL_Parameterss;
        [BizActorInputSetAttribute()]
        public LABEL_ParametersCollection LABEL_Parameterss
        {
            get
            {
                return this._LABEL_Parameterss;
            }
        }
        [BizActorInputSetDefineAttribute(Order="3")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class LABEL_Parameters : BizActorDataSetBase
        {
            public LABEL_Parameters()
            {
                RowLoadedFlag = false;
            }
            private bool _RowLoadedFlag;
            ...
            public string ParamName
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ParamName", value);
            ...
            public string ParamValue
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ParamValue", value);
        ...
        public BR_BRS_UPD_MaterialSubLot_ChangeQuantity()
        {
            RuleName = "BR_BRS_UPD_MaterialSubLot_ChangeQuantity";
            _INDATA_MLOTs = new INDATA_MLOTCollection();
            _INDATA_MSUBLOTs = new INDATA_MSUBLOTCollection();
            _LABEL_INDATAs = new LABEL_INDATACollection();
            _LABEL_Parameterss = new LABEL_ParametersCollection();
