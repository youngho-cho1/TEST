...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_EquipmentCustomAttributeValue_ScaleInfo_EQPTID
    /// </summary>
    public partial class BR_BRS_SEL_EquipmentCustomAttributeValue_ScaleInfo_EQPTID : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string RANGEMIN
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RANGEMIN", value);
                        this.OnPropertyChanged("RANGEMIN");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string RANGEMAX
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RANGEMAX", value);
                        this.OnPropertyChanged("RANGEMAX");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string MODEL
            {
                ...
                set
                {
                    ...
                    {
                        this._MODEL = value;
                        this.CheckIsOriginal("MODEL", value);
            ...
            public string PORT
            {
                ...
                set
                {
                    ...
                    {
                        this._PORT = value;
                        this.CheckIsOriginal("PORT", value);
            ...
            public string INTERFACE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("INTERFACE", value);
            ...
            private string _TARE_MANDATORY;
            [BizActorOutputItemAttribute()]
            public string TARE_MANDATORY
            {
                get
                {
                    return this._TARE_MANDATORY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._TARE_MANDATORY = value;
                        this.CheckIsOriginal("TARE_MANDATORY", value);
                        this.OnPropertyChanged("TARE_MANDATORY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_EquipmentCustomAttributeValue_ScaleInfo_EQPTID()
        {
            RuleName = "BR_BRS_SEL_EquipmentCustomAttributeValue_ScaleInfo_EQPTID";
