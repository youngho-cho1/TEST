...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_Yield_Compress_Loss
    /// </summary>
    public partial class BR_BRS_SEL_Yield_Compress_Loss : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<decimal> _SumYield;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> SumYield
            {
                get
                {
                    return this._SumYield;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._SumYield = value;
                        this.CheckIsOriginal("SumYield", value);
                        this.OnPropertyChanged("SumYield");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_Yield_Compress_Loss()
        {
            RuleName = "BR_BRS_SEL_Yield_Compress_Loss";
            BizName = "BR_BRS_SEL_Yield_Compress_Loss";
