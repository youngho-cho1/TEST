...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_Yield_Calculation_Granule
    /// </summary>
    public partial class BR_BRS_SEL_Yield_Calculation_Granule : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string LOSSQTY
            {
                ...
                set
                {
                    ...
                    {
                        this._LOSSQTY = value;
                        this.CheckIsOriginal("LOSSQTY", value);
                        this.OnPropertyChanged("LOSSQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_Yield_Calculation_Granule()
        {
            RuleName = "BR_BRS_SEL_Yield_Calculation_Granule";
