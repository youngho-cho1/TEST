...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_Yield_Calculation_Weight_Packing_INPUT_REQ
    /// </summary>
    public partial class BR_BRS_SEL_Yield_Calculation_Weight_Packing_INPUT_REQ : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _IN_VALUE1;
            [BizActorOutputItemAttribute()]
            public string IN_VALUE1
            {
                get
                {
                    return this._IN_VALUE1;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._IN_VALUE1 = value;
                        this.CheckIsOriginal("IN_VALUE1", value);
                        this.OnPropertyChanged("IN_VALUE1");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _IN_VALUE2;
            [BizActorOutputItemAttribute()]
            public string IN_VALUE2
            {
                get
                {
                    return this._IN_VALUE2;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._IN_VALUE2 = value;
                        this.CheckIsOriginal("IN_VALUE2", value);
                        this.OnPropertyChanged("IN_VALUE2");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_Yield_Calculation_Weight_Packing_INPUT_REQ()
        {
            RuleName = "BR_BRS_SEL_Yield_Calculation_Weight_Packing_INPUT_REQ";
            BizName = "BR_BRS_SEL_Yield_Calculation_Weight_Packing_INPUT_REQ";
