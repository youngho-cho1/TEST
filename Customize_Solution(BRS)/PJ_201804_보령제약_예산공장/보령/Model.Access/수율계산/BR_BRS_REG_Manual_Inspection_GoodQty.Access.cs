...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_Manual_Inspection_GoodQty
    /// </summary>
    public partial class BR_BRS_REG_Manual_Inspection_GoodQty : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string GOODQTY
            {
                ...
                set
                {
                    ...
                    {
                        this._GOODQTY = value;
                        this.CheckIsOriginal("GOODQTY", value);
                        this.OnPropertyChanged("GOODQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_Manual_Inspection_GoodQty()
        {
            RuleName = "BR_BRS_REG_Manual_Inspection_GoodQty";
            BizName = "수동 선별 양품 수량 기록";
