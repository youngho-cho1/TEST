...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrder_SAMPLEQTY
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrder_SAMPLEQTY : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _MSUBLOTEXPIRYSTAT;
            [BizActorOutputItemAttribute()]
            public string MSUBLOTEXPIRYSTAT
            {
                get
                {
                    return this._MSUBLOTEXPIRYSTAT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MSUBLOTEXPIRYSTAT = value;
                        this.CheckIsOriginal("MSUBLOTEXPIRYSTAT", value);
                        this.OnPropertyChanged("MSUBLOTEXPIRYSTAT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrder_SAMPLEQTY()
        {
            RuleName = "BR_BRS_SEL_ProductionOrder_SAMPLEQTY";
            BizName = "BR_BRS_SEL_ProductionOrder_SAMPLEQTY";
