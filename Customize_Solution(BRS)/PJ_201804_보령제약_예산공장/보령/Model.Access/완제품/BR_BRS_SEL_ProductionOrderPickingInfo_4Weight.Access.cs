...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderPickingInfo_4Weight
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderPickingInfo_4Weight : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _PICKING_QTY;
            [BizActorOutputItemAttribute()]
            public string PICKING_QTY
            {
                get
                {
                    return this._PICKING_QTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PICKING_QTY = value;
                        this.CheckIsOriginal("PICKING_QTY", value);
                        this.OnPropertyChanged("PICKING_QTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _NEED_WEIGHT;
            [BizActorOutputItemAttribute()]
            public string NEED_WEIGHT
            {
                get
                {
                    return this._NEED_WEIGHT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._NEED_WEIGHT = value;
                        this.CheckIsOriginal("NEED_WEIGHT", value);
                        this.OnPropertyChanged("NEED_WEIGHT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderPickingInfo_4Weight()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderPickingInfo_4Weight";
