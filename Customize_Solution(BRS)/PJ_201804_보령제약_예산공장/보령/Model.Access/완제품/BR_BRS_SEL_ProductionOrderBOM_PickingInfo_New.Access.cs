...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderBOM_PickingInfo_New
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderBOM_PickingInfo_New : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _ADDITIONALQTY;
            [BizActorOutputItemAttribute()]
            public string ADDITIONALQTY
            {
                get
                {
                    return this._ADDITIONALQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._ADDITIONALQTY = value;
                        this.CheckIsOriginal("ADDITIONALQTY", value);
                        this.OnPropertyChanged("ADDITIONALQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string RETURNQTY
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RETURNQTY", value);
                        this.OnPropertyChanged("RETURNQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderBOM_PickingInfo_New()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderBOM_PickingInfo_New";
