...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrder_FERT_Summary
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrder_FERT_Summary : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<int> _STORAGEINQTY;
            [BizActorOutputItemAttribute()]
            public System.Nullable<int> STORAGEINQTY
            {
                get
                {
                    return this._STORAGEINQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._STORAGEINQTY = value;
                        this.CheckIsOriginal("STORAGEINQTY", value);
                        this.OnPropertyChanged("STORAGEINQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _CONVERTPARAM;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> CONVERTPARAM
            {
                get
                {
                ...
                set
                {
                    ...
                    {
                        this._CONVERTPARAM = value;
                        this.CheckIsOriginal("CONVERTPARAM", value);
                        this.OnPropertyChanged("CONVERTPARAM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrder_FERT_Summary()
        {
            RuleName = "BR_BRS_SEL_ProductionOrder_FERT_Summary";
