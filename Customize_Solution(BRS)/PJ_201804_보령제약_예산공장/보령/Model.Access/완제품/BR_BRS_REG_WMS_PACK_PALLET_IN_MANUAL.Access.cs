...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_WMS_PACK_PALLET_IN_MANUAL
    /// </summary>
    public partial class BR_BRS_REG_WMS_PACK_PALLET_IN_MANUAL : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _IN_LOCATION;
            [BizActorInputItemAttribute()]
            public string IN_LOCATION
            {
                get
                {
                    return this._IN_LOCATION;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._IN_LOCATION = value;
                        this.CheckIsOriginal("IN_LOCATION", value);
                        this.OnPropertyChanged("IN_LOCATION");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<int> _OUTPUTQTY;
            [BizActorInputItemAttribute()]
            public System.Nullable<int> OUTPUTQTY
            {
                get
                {
        ...
        public BR_BRS_REG_WMS_PACK_PALLET_IN_MANUAL()
        {
            RuleName = "BR_BRS_REG_WMS_PACK_PALLET_IN_MANUAL";
