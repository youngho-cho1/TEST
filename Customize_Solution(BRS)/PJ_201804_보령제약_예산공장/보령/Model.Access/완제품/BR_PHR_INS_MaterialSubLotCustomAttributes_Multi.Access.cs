...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_PHR_INS_MaterialSubLotCustomAttributes_Multi
    /// </summary>
    public partial class BR_PHR_INS_MaterialSubLotCustomAttributes_Multi : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _MTATID;
            [BizActorInputItemAttribute()]
            public string MTATID
            {
                get
                {
                    return this._MTATID;
                ...
                set
                {
                    ...
                    {
                        this._MTATID = value;
                        this.CheckIsOriginal("MTATID", value);
                        this.OnPropertyChanged("MTATID");
                        if (RowLoadedFlag)
                        {
            ...
            private string _MTATVAL2;
            [BizActorInputItemAttribute()]
            public string MTATVAL2
            {
                get
                {
                    return this._MTATVAL2;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MTATVAL2 = value;
                        this.CheckIsOriginal("MTATVAL2", value);
                        this.OnPropertyChanged("MTATVAL2");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class INDATA_SUBLOTCollection : BufferedObservableCollection<INDATA_SUBLOT>
        {
        }
        private INDATA_SUBLOTCollection _INDATA_SUBLOTs;
        [BizActorInputSetAttribute()]
        public INDATA_SUBLOTCollection INDATA_SUBLOTs
        {
            get
            {
                return this._INDATA_SUBLOTs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class INDATA_SUBLOT : BizActorDataSetBase
        {
            public INDATA_SUBLOT()
            {
                RowLoadedFlag = false;
            }
            private bool _RowLoadedFlag;
            ...
            private string _MSUBLOTVERFROM;
            [BizActorInputItemAttribute()]
            public string MSUBLOTVERFROM
            {
                get
                {
                    return this._MSUBLOTVERFROM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MSUBLOTVERFROM = value;
                        this.CheckIsOriginal("MSUBLOTVERFROM", value);
                        this.OnPropertyChanged("MSUBLOTVERFROM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_PHR_INS_MaterialSubLotCustomAttributes_Multi()
        {
            RuleName = "BR_PHR_INS_MaterialSubLotCustomAttributes_Multi";
            _INDATAs = new INDATACollection();
            _INDATA_SUBLOTs = new INDATA_SUBLOTCollection();
