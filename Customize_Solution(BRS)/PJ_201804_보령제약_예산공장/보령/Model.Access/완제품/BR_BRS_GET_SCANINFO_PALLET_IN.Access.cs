...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_SCANINFO_PALLET_IN
    /// </summary>
    public partial class BR_BRS_GET_SCANINFO_PALLET_IN : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _OPGSGUID;
            [BizActorInputItemAttribute()]
            public string OPGSGUID
            {
                get
                {
                    return this._OPGSGUID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._OPGSGUID = value;
                        this.CheckIsOriginal("OPGSGUID", value);
                        this.OnPropertyChanged("OPGSGUID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string SCANDATA
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("SCANDATA", value);
                        this.OnPropertyChanged("SCANDATA");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _SCANDATATYPE;
            [BizActorOutputItemAttribute()]
            public string SCANDATATYPE
            {
                get
                {
                    return this._SCANDATATYPE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._SCANDATATYPE = value;
                        this.CheckIsOriginal("SCANDATATYPE", value);
                        this.OnPropertyChanged("SCANDATATYPE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_GET_SCANINFO_PALLET_IN()
        {
            RuleName = "BR_BRS_GET_SCANINFO_PALLET_IN";
