...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_EquipmentStatus_Output_Scale
    /// </summary>
    public partial class BR_BRS_REG_EquipmentStatus_Output_Scale : BizActorRuleBase
    {
        public sealed partial class E_INDATACollection : BufferedObservableCollection<E_INDATA>
        {
        }
        private E_INDATACollection _E_INDATAs;
        [BizActorInputSetAttribute()]
        public E_INDATACollection E_INDATAs
        {
            get
            {
                return this._E_INDATAs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="0")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class E_INDATA : BizActorDataSetBase
        {
            public E_INDATA()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class E_PARAMDATACollection : BufferedObservableCollection<E_PARAMDATA>
        {
        }
        private E_PARAMDATACollection _E_PARAMDATAs;
        [BizActorInputSetAttribute()]
        public E_PARAMDATACollection E_PARAMDATAs
        {
            get
            {
                return this._E_PARAMDATAs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class E_PARAMDATA : BizActorDataSetBase
        {
            public E_PARAMDATA()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class O_INDATACollection : BufferedObservableCollection<O_INDATA>
        {
        }
        private O_INDATACollection _O_INDATAs;
        [BizActorInputSetAttribute()]
        public O_INDATACollection O_INDATAs
        {
            get
            {
                return this._O_INDATAs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="2")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class O_INDATA : BizActorDataSetBase
        {
            public O_INDATA()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class E_HISDATACollection : BufferedObservableCollection<E_HISDATA>
        {
        }
        private E_HISDATACollection _E_HISDATAs;
        [BizActorOutputSetAttribute()]
        public E_HISDATACollection E_HISDATAs
        {
            get
            {
                return this._E_HISDATAs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="0")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class E_HISDATA : BizActorDataSetBase
        {
            public E_HISDATA()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class O_OUTDATACollection : BufferedObservableCollection<O_OUTDATA>
        {
        }
        private O_OUTDATACollection _O_OUTDATAs;
        [BizActorOutputSetAttribute()]
        public O_OUTDATACollection O_OUTDATAs
        {
            get
            {
                return this._O_OUTDATAs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class O_OUTDATA : BizActorDataSetBase
        {
            public O_OUTDATA()
            {
                RowLoadedFlag = false;
        ...
        public sealed partial class O_HISDATACollection : BufferedObservableCollection<O_HISDATA>
        {
        }
        private O_HISDATACollection _O_HISDATAs;
        [BizActorOutputSetAttribute()]
        public O_HISDATACollection O_HISDATAs
        {
            get
            {
                return this._O_HISDATAs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="2")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class O_HISDATA : BizActorDataSetBase
        {
            public O_HISDATA()
            {
                RowLoadedFlag = false;
        ...
        public BR_BRS_REG_EquipmentStatus_Output_Scale()
        {
            RuleName = "BR_BRS_REG_EquipmentStatus_Output_Scale";
            _E_INDATAs = new E_INDATACollection();
            _E_PARAMDATAs = new E_PARAMDATACollection();
            _O_INDATAs = new O_INDATACollection();
            _E_HISDATAs = new E_HISDATACollection();
            _O_OUTDATAs = new O_OUTDATACollection();
            _O_HISDATAs = new O_HISDATACollection();
        }
    }
}
