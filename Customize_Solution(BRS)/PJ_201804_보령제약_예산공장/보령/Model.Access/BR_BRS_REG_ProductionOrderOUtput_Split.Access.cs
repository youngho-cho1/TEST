...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_ProductionOrderOUtput_Split
    /// </summary>
    public partial class BR_BRS_REG_ProductionOrderOUtput_Split : BizActorRuleBase
    {
        ...
        public partial class INDATA_MSUBLOT : BizActorDataSetBase
        {
            ...
            private System.Nullable<float> _OLDMSUBLOTQTY;
            [BizActorInputItemAttribute()]
            public System.Nullable<float> OLDMSUBLOTQTY
            {
                get
                {
        ...
        public BR_BRS_REG_ProductionOrderOUtput_Split()
        {
            RuleName = "BR_BRS_REG_ProductionOrderOUtput_Split";
            BizName = "용기사용 시작 및 반제품 실적 Split 처리";
