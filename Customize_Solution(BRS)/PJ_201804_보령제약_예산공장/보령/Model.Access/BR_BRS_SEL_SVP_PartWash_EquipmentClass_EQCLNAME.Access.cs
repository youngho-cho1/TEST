...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_SVP_PartWash_EquipmentClass_EQCLNAME
    /// </summary>
    public partial class BR_BRS_SEL_SVP_PartWash_EquipmentClass_EQCLNAME : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _EQCLDESC;
            [BizActorOutputItemAttribute()]
            public string EQCLDESC
            {
                get
                {
                    return this._EQCLDESC;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQCLDESC = value;
                        this.CheckIsOriginal("EQCLDESC", value);
                        this.OnPropertyChanged("EQCLDESC");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_SVP_PartWash_EquipmentClass_EQCLNAME()
        {
            RuleName = "BR_BRS_SEL_SVP_PartWash_EquipmentClass_EQCLNAME";
            BizName = "BR_BRS_SEL_SVP_PartWash_EquipmentClass_EQCLNAME";
