...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_ProductionOrderTestSpecificationResult
    /// </summary>
    public partial class BR_BRS_GET_ProductionOrderTestSpecificationResult : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _POTSRGUID;
            [BizActorOutputItemAttribute()]
            public string POTSRGUID
            {
                get
                {
            ...
            private string _SMPQTYUOMNAME;
            [BizActorOutputItemAttribute()]
            public string SMPQTYUOMNAME
            {
                get
                {
                    return this._SMPQTYUOMNAME;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._SMPQTYUOMNAME = value;
                        this.CheckIsOriginal("SMPQTYUOMNAME", value);
                        this.OnPropertyChanged("SMPQTYUOMNAME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string TIID
            {
                ...
                set
                {
                    ...
                    {
                        this._TIID = value;
                        this.CheckIsOriginal("TIID", value);
                        this.OnPropertyChanged("TIID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string BASELINE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("BASELINE", value);
            ...
            public string CYCLE
            {
                ...
                set
                {
                    ...
                    {
                        this._CYCLE = value;
                        this.CheckIsOriginal("CYCLE", value);
            ...
            public string OPERATOR
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("OPERATOR", value);
            ...
            public string INSDATE
            {
                ...
                set
                {
                    ...
                    {
                        this._INSDATE = value;
                        this.CheckIsOriginal("INSDATE", value);
                        this.OnPropertyChanged("INSDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string SMPDATE
            {
                ...
                set
                {
                    ...
                    {
                        this._SMPDATE = value;
                        this.CheckIsOriginal("SMPDATE", value);
                        this.OnPropertyChanged("SMPDATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_GET_ProductionOrderTestSpecificationResult()
        {
            RuleName = "BR_BRS_GET_ProductionOrderTestSpecificationResult";
