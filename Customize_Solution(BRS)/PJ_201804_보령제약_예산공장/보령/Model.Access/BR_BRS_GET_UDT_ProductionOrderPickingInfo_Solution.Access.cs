...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_UDT_ProductionOrderPickingInfo_Solution
    /// </summary>
    public partial class BR_BRS_GET_UDT_ProductionOrderPickingInfo_Solution : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _QCT_NO_SEQ;
            [BizActorOutputItemAttribute()]
            public string QCT_NO_SEQ
            {
                get
                {
                    return this._QCT_NO_SEQ;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._QCT_NO_SEQ = value;
                        this.CheckIsOriginal("QCT_NO_SEQ", value);
                        this.OnPropertyChanged("QCT_NO_SEQ");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PICKING_RESV_QTY;
            [BizActorOutputItemAttribute()]
            public string PICKING_RESV_QTY
            {
                get
                {
                    return this._PICKING_RESV_QTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PICKING_RESV_QTY = value;
                        this.CheckIsOriginal("PICKING_RESV_QTY", value);
                        this.OnPropertyChanged("PICKING_RESV_QTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_GET_UDT_ProductionOrderPickingInfo_Solution()
        {
            RuleName = "BR_BRS_GET_UDT_ProductionOrderPickingInfo_Solution";
