...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_SVP_AreaWeighing_Dispensing_Component
    /// </summary>
    public partial class BR_BRS_SEL_SVP_AreaWeighing_Dispensing_Component : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<int> _SRCPRECISION;
            [BizActorOutputItemAttribute()]
            public System.Nullable<int> SRCPRECISION
            {
                get
                {
                    return this._SRCPRECISION;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._SRCPRECISION = value;
                        this.CheckIsOriginal("SRCPRECISION", value);
                        this.OnPropertyChanged("SRCPRECISION");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_SVP_AreaWeighing_Dispensing_Component()
        {
            RuleName = "BR_BRS_SEL_SVP_AreaWeighing_Dispensing_Component";
            BizName = "BR_BRS_SEL_SVP_AreaWeighing_Dispensing_Component";
