...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_EquipmentStatus_4CleanBooth_Multi
    /// </summary>
    public partial class BR_BRS_SEL_EquipmentStatus_4CleanBooth_Multi : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string PROC_STATUS
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PROC_STATUS", value);
            ...
            private string _FILTER_STATUS;
            [BizActorOutputItemAttribute()]
            public string FILTER_STATUS
            {
                get
                {
                    return this._FILTER_STATUS;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("FILTER_STATUS", value);
                        this.OnPropertyChanged("FILTER_STATUS");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _WINDSPEED_STATUS;
            [BizActorOutputItemAttribute()]
            public string WINDSPEED_STATUS
            {
                get
                {
                    return this._WINDSPEED_STATUS;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WINDSPEED_STATUS = value;
                        this.CheckIsOriginal("WINDSPEED_STATUS", value);
                        this.OnPropertyChanged("WINDSPEED_STATUS");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PROC_ONOFF;
            [BizActorOutputItemAttribute()]
            public string PROC_ONOFF
            {
                get
                {
                    return this._PROC_ONOFF;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PROC_ONOFF = value;
                        this.CheckIsOriginal("PROC_ONOFF", value);
                        this.OnPropertyChanged("PROC_ONOFF");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _FILTERCHECK_ONOFF;
            [BizActorOutputItemAttribute()]
            public string FILTERCHECK_ONOFF
            {
                get
                {
                    return this._FILTERCHECK_ONOFF;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FILTERCHECK_ONOFF = value;
                        this.CheckIsOriginal("FILTERCHECK_ONOFF", value);
                        this.OnPropertyChanged("FILTERCHECK_ONOFF");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _WINDSPEED_ONOFF;
            [BizActorOutputItemAttribute()]
            public string WINDSPEED_ONOFF
            {
                get
                {
                    return this._WINDSPEED_ONOFF;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._WINDSPEED_ONOFF = value;
                        this.CheckIsOriginal("WINDSPEED_ONOFF", value);
                        this.OnPropertyChanged("WINDSPEED_ONOFF");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _PROC_CHECKEDDTTM;
            [BizActorOutputItemAttribute()]
            public string PROC_CHECKEDDTTM
            {
                get
                {
                    return this._PROC_CHECKEDDTTM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PROC_CHECKEDDTTM = value;
                        this.CheckIsOriginal("PROC_CHECKEDDTTM", value);
                        this.OnPropertyChanged("PROC_CHECKEDDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_EquipmentStatus_4CleanBooth_Multi()
        {
            RuleName = "BR_BRS_SEL_EquipmentStatus_4CleanBooth_Multi";
