...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductOrder_JOB_HIST
    /// </summary>
    public partial class BR_BRS_SEL_ProductOrder_JOB_HIST : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _EQSJUSER;
            [BizActorOutputItemAttribute()]
            public string EQSJUSER
            {
                get
                {
                    return this._EQSJUSER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
            ...
            private System.Nullable<System.DateTime> _EQSJSTDTTM;
            [BizActorOutputItemAttribute()]
            public System.Nullable<System.DateTime> EQSJSTDTTM
            {
                get
                {
                    return this._EQSJSTDTTM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQSJSTDTTM = value;
                        this.CheckIsOriginal("EQSJSTDTTM", value);
                        this.OnPropertyChanged("EQSJSTDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<System.DateTime> _EQSJEDDTTM;
            [BizActorOutputItemAttribute()]
            public System.Nullable<System.DateTime> EQSJEDDTTM
            {
                get
                {
                    return this._EQSJEDDTTM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQSJEDDTTM = value;
                        this.CheckIsOriginal("EQSJEDDTTM", value);
                        this.OnPropertyChanged("EQSJEDDTTM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string TACKTIME
            {
                ...
                set
                {
                    ...
                    {
                        this._TACKTIME = value;
                        this.CheckIsOriginal("TACKTIME", value);
                        this.OnPropertyChanged("TACKTIME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductOrder_JOB_HIST()
        {
            RuleName = "BR_BRS_SEL_ProductOrder_JOB_HIST";
            BizName = "BR_BRS_SEL_ProductOrder_JOB_HIST";
