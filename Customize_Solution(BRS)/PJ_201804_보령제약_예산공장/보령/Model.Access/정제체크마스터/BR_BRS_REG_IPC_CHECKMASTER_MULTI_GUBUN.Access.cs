...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_IPC_CHECKMASTER_MULTI_GUBUN
    /// </summary>
    public partial class BR_BRS_REG_IPC_CHECKMASTER_MULTI_GUBUN : BizActorRuleBase
    {
        ...
        public BR_BRS_REG_IPC_CHECKMASTER_MULTI_GUBUN()
        {
            RuleName = "BR_BRS_REG_IPC_CHECKMASTER_MULTI_GUBUN";
            BizName = "타정기 체크마스터(원형/비원형) 저장";
