...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderOutput_LoadedPallet
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderOutput_LoadedPallet : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string ISLOADED
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ISLOADED", value);
            ...
            private string _EXCEPT_ZERO;
            [BizActorInputItemAttribute()]
            public string EXCEPT_ZERO
            {
                get
                {
                    return this._EXCEPT_ZERO;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EXCEPT_ZERO = value;
                        this.CheckIsOriginal("EXCEPT_ZERO", value);
                        this.OnPropertyChanged("EXCEPT_ZERO");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _LOADED_VESSELID;
            [BizActorOutputItemAttribute()]
            public string LOADED_VESSELID
            {
                get
                {
                    return this._LOADED_VESSELID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._LOADED_VESSELID = value;
                        this.CheckIsOriginal("LOADED_VESSELID", value);
                        this.OnPropertyChanged("LOADED_VESSELID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string SEL
            {
                ...
                set
                {
                    ...
                    {
                        this._SEL = value;
                        this.CheckIsOriginal("SEL", value);
                        this.OnPropertyChanged("SEL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderOutput_LoadedPallet()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderOutput_LoadedPallet";
