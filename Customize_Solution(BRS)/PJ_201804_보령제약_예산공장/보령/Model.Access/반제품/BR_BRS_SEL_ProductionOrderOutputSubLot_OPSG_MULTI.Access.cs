...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_PHR_SEL_ProductionOrderOutputSubLot_OPSG_MULTI
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_MULTI : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string OUTPUTDESC
            {
                ...
                set
                {
                    ...
                    {
                        this._OUTPUTDESC = value;
                        this.CheckIsOriginal("OUTPUTDESC", value);
                        this.OnPropertyChanged("OUTPUTDESC");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string OUTPUTTYPE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("OUTPUTTYPE", value);
            ...
            public System.Nullable<long> ROWNUM
            {
                ...
                set
                {
                    ...
                    {
                        this._ROWNUM = value;
                        this.CheckIsOriginal("ROWNUM", value);
            ...
            private string _INSDTTM_PO;
            [BizActorOutputItemAttribute()]
            public string INSDTTM_PO
            {
                get
                {
                    return this._INSDTTM_PO;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INSDTTM_PO = value;
                        this.CheckIsOriginal("INSDTTM_PO", value);
                        this.OnPropertyChanged("INSDTTM_PO");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _INSUSER_PO;
            [BizActorOutputItemAttribute()]
            public string INSUSER_PO
            {
                get
                {
                    return this._INSUSER_PO;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INSUSER_PO = value;
                        this.CheckIsOriginal("INSUSER_PO", value);
                        this.OnPropertyChanged("INSUSER_PO");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _INSDTTM_MS;
            [BizActorOutputItemAttribute()]
            public string INSDTTM_MS
            {
                get
                {
                    return this._INSDTTM_MS;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INSDTTM_MS = value;
                        this.CheckIsOriginal("INSDTTM_MS", value);
                        this.OnPropertyChanged("INSDTTM_MS");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _INSUSER_MS;
            [BizActorOutputItemAttribute()]
            public string INSUSER_MS
            {
                get
                {
                    return this._INSUSER_MS;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INSUSER_MS = value;
                        this.CheckIsOriginal("INSUSER_MS", value);
                        this.OnPropertyChanged("INSUSER_MS");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _INSUSERNAME_PO;
            [BizActorOutputItemAttribute()]
            public string INSUSERNAME_PO
            {
                get
                {
                    return this._INSUSERNAME_PO;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INSUSERNAME_PO = value;
                        this.CheckIsOriginal("INSUSERNAME_PO", value);
                        this.OnPropertyChanged("INSUSERNAME_PO");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _INSUSERNAME_MS;
            [BizActorOutputItemAttribute()]
            public string INSUSERNAME_MS
            {
                get
                {
                    return this._INSUSERNAME_MS;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INSUSERNAME_MS = value;
                        this.CheckIsOriginal("INSUSERNAME_MS", value);
                        this.OnPropertyChanged("INSUSERNAME_MS");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class OUTDATA_SUMCollection : BufferedObservableCollection<OUTDATA_SUM>
        {
        }
        private OUTDATA_SUMCollection _OUTDATA_SUMs;
        [BizActorOutputSetAttribute()]
        public OUTDATA_SUMCollection OUTDATA_SUMs
        {
            get
            {
                return this._OUTDATA_SUMs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class OUTDATA_SUM : BizActorDataSetBase
        {
            public OUTDATA_SUM()
            {
                RowLoadedFlag = false;
            ...
            private System.Nullable<decimal> _MSUBLOTQTY_SUM;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> MSUBLOTQTY_SUM
            {
                get
                {
                    return this._MSUBLOTQTY_SUM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MSUBLOTQTY_SUM = value;
                        this.CheckIsOriginal("MSUBLOTQTY_SUM", value);
                        this.OnPropertyChanged("MSUBLOTQTY_SUM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_MULTI()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_MULTI";
            _INDATAs = new INDATACollection();
            _OUTDATAs = new OUTDATACollection();
            _OUTDATA_SUMs = new OUTDATA_SUMCollection();
        }
    }
}
