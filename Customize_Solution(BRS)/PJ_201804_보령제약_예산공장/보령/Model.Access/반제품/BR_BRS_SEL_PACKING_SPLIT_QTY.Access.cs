...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_PACKING_SPLIT_QTY
    /// </summary>
    public partial class BR_BRS_SEL_PACKING_SPLIT_QTY : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string PACK_QTY
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("PACK_QTY", value);
            ...
            private string _STDPRODQTY;
            [BizActorOutputItemAttribute()]
            public string STDPRODQTY
            {
                get
                {
                    return this._STDPRODQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._STDPRODQTY = value;
                        this.CheckIsOriginal("STDPRODQTY", value);
                        this.OnPropertyChanged("STDPRODQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _NET_SUM_WEIGHT;
            [BizActorOutputItemAttribute()]
            public string NET_SUM_WEIGHT
            {
                get
                {
                    return this._NET_SUM_WEIGHT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._NET_SUM_WEIGHT = value;
                        this.CheckIsOriginal("NET_SUM_WEIGHT", value);
                        this.OnPropertyChanged("NET_SUM_WEIGHT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _MIN_CALCULATE;
            [BizActorOutputItemAttribute()]
            public string MIN_CALCULATE
            {
                get
                {
                    return this._MIN_CALCULATE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MIN_CALCULATE = value;
                        this.CheckIsOriginal("MIN_CALCULATE", value);
                        this.OnPropertyChanged("MIN_CALCULATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string CALCULATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("CALCULATE", value);
                        this.OnPropertyChanged("CALCULATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _MAX_CALCULATE;
            [BizActorOutputItemAttribute()]
            public string MAX_CALCULATE
            {
                get
                {
                    return this._MAX_CALCULATE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._MAX_CALCULATE = value;
                        this.CheckIsOriginal("MAX_CALCULATE", value);
                        this.OnPropertyChanged("MAX_CALCULATE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_PACKING_SPLIT_QTY()
        {
            RuleName = "BR_BRS_SEL_PACKING_SPLIT_QTY";
            BizName = "BR_BRS_SEL_PACKING_SPLIT_QTY";
