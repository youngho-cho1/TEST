...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_VESSEL_INFO_DETAIL
    /// </summary>
    public partial class BR_BRS_GET_VESSEL_INFO_DETAIL : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _VESSEL_TYPE;
            [BizActorOutputItemAttribute()]
            public string VESSEL_TYPE
            {
                get
                {
                    return this._VESSEL_TYPE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._VESSEL_TYPE = value;
                        this.CheckIsOriginal("VESSEL_TYPE", value);
                        this.OnPropertyChanged("VESSEL_TYPE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _VESSEL_TYPE_NAME;
            [BizActorOutputItemAttribute()]
            public string VESSEL_TYPE_NAME
            {
                get
                {
                    return this._VESSEL_TYPE_NAME;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._VESSEL_TYPE_NAME = value;
                        this.CheckIsOriginal("VESSEL_TYPE_NAME", value);
                        this.OnPropertyChanged("VESSEL_TYPE_NAME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public System.Nullable<decimal> TOTALQTY
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("TOTALQTY", value);
            ...
            private string _EQPTTYPE;
            [BizActorOutputItemAttribute()]
            public string EQPTTYPE
            {
                get
                {
                    return this._EQPTTYPE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._EQPTTYPE = value;
                        this.CheckIsOriginal("EQPTTYPE", value);
                        this.OnPropertyChanged("EQPTTYPE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string CHECKTYPE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("CHECKTYPE", value);
        ...
        public partial class OUTDATA_DETAIL : BizActorDataSetBase
        {
            ...
            private string _CHK_FLAG;
            [BizActorOutputItemAttribute()]
            public string CHK_FLAG
            {
                get
                {
                    return this._CHK_FLAG;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._CHK_FLAG = value;
                        this.CheckIsOriginal("CHK_FLAG", value);
                        this.OnPropertyChanged("CHK_FLAG");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _TOTALQTY_UPPER;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> TOTALQTY_UPPER
            {
                get
                {
                    return this._TOTALQTY_UPPER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._TOTALQTY_UPPER = value;
                        this.CheckIsOriginal("TOTALQTY_UPPER", value);
                        this.OnPropertyChanged("TOTALQTY_UPPER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _TOTALQTY_LOWER;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> TOTALQTY_LOWER
            {
                get
                {
                    return this._TOTALQTY_LOWER;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._TOTALQTY_LOWER = value;
                        this.CheckIsOriginal("TOTALQTY_LOWER", value);
                        this.OnPropertyChanged("TOTALQTY_LOWER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _REALQTY;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> REALQTY
            {
                get
                {
                ...
                set
                {
                    ...
                    {
                        this._REALQTY = value;
                        this.CheckIsOriginal("REALQTY", value);
                        this.OnPropertyChanged("REALQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string CHECKWEIGHT
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("CHECKWEIGHT", value);
                        this.OnPropertyChanged("CHECKWEIGHT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public sealed partial class OUTDATA_WIPCollection : BufferedObservableCollection<OUTDATA_WIP>
        {
        }
        private OUTDATA_WIPCollection _OUTDATA_WIPs;
        [BizActorOutputSetAttribute()]
        public OUTDATA_WIPCollection OUTDATA_WIPs
        {
            get
            {
                return this._OUTDATA_WIPs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order = "2")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class OUTDATA_WIP : BizActorDataSetBase
        {
            public OUTDATA_WIP()
            {
                RowLoadedFlag = false;
        ...
        public BR_BRS_GET_VESSEL_INFO_DETAIL()
        {
            RuleName = "BR_BRS_GET_VESSEL_INFO_DETAIL";
            _INDATAs = new INDATACollection();
            _OUTDATAs = new OUTDATACollection();
            _OUTDATA_DETAILs = new OUTDATA_DETAILCollection();
            _OUTDATA_WIPs = new OUTDATA_WIPCollection();
        }
    }
}
