...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_MaterialSubLot_Dispense_Charging_EQAC
    /// </summary>
    public partial class BR_BRS_REG_MaterialSubLot_Dispense_Charging_EQAC : BizActorRuleBase
    {
        ...
        public sealed partial class INDATA_INVCollection : BufferedObservableCollection<INDATA_INV>
        {
        }
        private INDATA_INVCollection _INDATA_INVs;
        [BizActorInputSetAttribute()]
        public INDATA_INVCollection INDATA_INVs
        {
            get
            {
                return this._INDATA_INVs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class INDATA_INV : BizActorDataSetBase
        {
            public INDATA_INV()
            {
                RowLoadedFlag = false;
        ...
        public BR_BRS_REG_MaterialSubLot_Dispense_Charging_EQAC()
        {
            RuleName = "BR_BRS_REG_MaterialSubLot_Dispense_Charging_EQAC";
