...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderOutput_Emtpy_Vessel
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderOutput_Emtpy_Vessel : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _TAREWEIGHTSTR;
            [BizActorOutputItemAttribute()]
            public string TAREWEIGHTSTR
            {
                get
                {
                    return this._TAREWEIGHTSTR;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._TAREWEIGHTSTR = value;
                        this.CheckIsOriginal("TAREWEIGHTSTR", value);
                        this.OnPropertyChanged("TAREWEIGHTSTR");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderOutput_Emtpy_Vessel()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderOutput_Emtpy_Vessel";
            BizName = "BR_BRS_SEL_ProductionOrderOutput_Emtpy_Vessel";
