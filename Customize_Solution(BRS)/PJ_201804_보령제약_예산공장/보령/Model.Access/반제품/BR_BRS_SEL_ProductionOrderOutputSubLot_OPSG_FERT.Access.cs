...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_FERT
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_FERT : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _PMSWEIGHT;
            [BizActorOutputItemAttribute()]
            public string PMSWEIGHT
            {
                get
                {
                    return this._PMSWEIGHT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PMSWEIGHT = value;
                        this.CheckIsOriginal("PMSWEIGHT", value);
                        this.OnPropertyChanged("PMSWEIGHT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_FERT()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderOutputSubLot_OPSG_FERT";
