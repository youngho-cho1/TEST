...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_Blender_Recipe_To_Eqpt
    /// </summary>
    public partial class BR_BRS_REG_Blender_Recipe_To_Eqpt : BizActorRuleBase
    {
            ...
            public string RECIPEID
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RECIPEID", value);
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string RESULTFLAG
            {
                ...
                set
                {
                    ...
                    {
                        this._RESULTFLAG = value;
                        this.CheckIsOriginal("RESULTFLAG", value);
                        this.OnPropertyChanged("RESULTFLAG");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_Blender_Recipe_To_Eqpt()
        {
            RuleName = "BR_BRS_REG_Blender_Recipe_To_Eqpt";
            BizName = "혼합기 Recipe 전송";
