...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_ProductionOrder_Dispence_Split_Charging
    /// </summary>
    public partial class BR_BRS_REG_ProductionOrder_Dispence_Split_Charging : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _FROM_VESSELID;
            [BizActorOutputItemAttribute()]
            public string FROM_VESSELID
            {
                get
                {
                    return this._FROM_VESSELID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FROM_VESSELID = value;
                        this.CheckIsOriginal("FROM_VESSELID", value);
                        this.OnPropertyChanged("FROM_VESSELID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _TO_VESSELID;
            [BizActorOutputItemAttribute()]
            public string TO_VESSELID
            {
                get
                {
                    return this._TO_VESSELID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._TO_VESSELID = value;
                        this.CheckIsOriginal("TO_VESSELID", value);
                        this.OnPropertyChanged("TO_VESSELID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_ProductionOrder_Dispence_Split_Charging()
        {
            RuleName = "BR_BRS_REG_ProductionOrder_Dispence_Split_Charging";
            BizName = "BR_BRS_REG_ProductionOrder_Dispence_Split_Scrap";
