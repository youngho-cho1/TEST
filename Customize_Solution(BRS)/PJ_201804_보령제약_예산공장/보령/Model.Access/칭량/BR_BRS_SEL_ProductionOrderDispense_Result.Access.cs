...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderDispense_Result
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderDispense_Result : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _DSP_VESSEL;
            [BizActorOutputItemAttribute()]
            public string DSP_VESSEL
            {
                get
                {
                    return this._DSP_VESSEL;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._DSP_VESSEL = value;
                        this.CheckIsOriginal("DSP_VESSEL", value);
                        this.OnPropertyChanged("DSP_VESSEL");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string TOTALWEIGHT
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("TOTALWEIGHT", value);
            ...
            private System.Nullable<short> _WEIGHINGSEQ;
            [BizActorOutputItemAttribute()]
            public System.Nullable<short> WEIGHINGSEQ
            {
                get
                {
