...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrderAllocation_AreaWeighing
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrderAllocation_AreaWeighing : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private System.Nullable<decimal> _INITRESERVEQTY;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> INITRESERVEQTY
            {
                get
                {
                    return this._INITRESERVEQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._INITRESERVEQTY = value;
                        this.CheckIsOriginal("INITRESERVEQTY", value);
                        this.OnPropertyChanged("INITRESERVEQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _RESERVEQTY;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> RESERVEQTY
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("RESERVEQTY", value);
                        this.OnPropertyChanged("RESERVEQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _UPPER;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> UPPER
            {
                ...
                set
                {
                    ...
                    {
                        this._UPPER = value;
                        this.CheckIsOriginal("UPPER", value);
                        this.OnPropertyChanged("UPPER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<decimal> _LOWER;
            [BizActorOutputItemAttribute()]
            public System.Nullable<decimal> LOWER
            {
                ...
                set
                {
                    ...
                    {
                        this._LOWER = value;
                        this.CheckIsOriginal("LOWER", value);
                        this.OnPropertyChanged("LOWER");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private System.Nullable<int> _BOMPRECISION;
            [BizActorOutputItemAttribute()]
            public System.Nullable<int> BOMPRECISION
            {
                get
                {
                    return this._BOMPRECISION;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._BOMPRECISION = value;
                        this.CheckIsOriginal("BOMPRECISION", value);
                        this.OnPropertyChanged("BOMPRECISION");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrderAllocation_AreaWeighing()
        {
            RuleName = "BR_BRS_SEL_ProductionOrderAllocation_AreaWeighing";
