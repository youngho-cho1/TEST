...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_Dispense_Charging_Solvent_Add
    /// </summary>
    public partial class BR_BRS_REG_Dispense_Charging_Solvent_Add : BizActorRuleBase
    {
        ...
        public sealed partial class INDATA_SUBCollection : BufferedObservableCollection<INDATA_SUB>
        {
        }
        private INDATA_SUBCollection _INDATA_SUBs;
        [BizActorInputSetAttribute()]
        public INDATA_SUBCollection INDATA_SUBs
        {
            get
            {
                return this._INDATA_SUBs;
            }
        }
        [BizActorInputSetDefineAttribute(Order="1")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class INDATA_SUB : BizActorDataSetBase
        {
            public INDATA_SUB()
            {
                RowLoadedFlag = false;
            ...
            public string HEADER1
            {
                ...
                set
                {
                    ...
                    {
                        this._HEADER1 = value;
                        this.CheckIsOriginal("HEADER1", value);
            ...
            public string HEADER2
            {
                ...
                set
                {
                    ...
                    {
                        this._HEADER2 = value;
                        this.CheckIsOriginal("HEADER2", value);
            ...
            private string _FROZENQTY;
            [BizActorInputItemAttribute()]
            public string FROZENQTY
            {
                get
                {
                    return this._FROZENQTY;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FROZENQTY = value;
                        this.CheckIsOriginal("FROZENQTY", value);
                        this.OnPropertyChanged("FROZENQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_Dispense_Charging_Solvent_Add()
        {
            RuleName = "BR_BRS_REG_Dispense_Charging_Solvent_Add";
            _INDATAs = new INDATACollection();
            _INDATA_SUBs = new INDATA_SUBCollection();
