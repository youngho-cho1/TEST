...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_ProductionOrderDispense_VesselInfo
    /// </summary>
    public partial class BR_BRS_ProductionOrderDispense_VesselInfo : BizActorRuleBase
    {
            ...
            public string CONFIRMYN
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("CONFIRMYN", value);
                        this.OnPropertyChanged("CONFIRMYN");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_ProductionOrderDispense_VesselInfo()
        {
            RuleName = "BR_BRS_ProductionOrderDispense_VesselInfo";
