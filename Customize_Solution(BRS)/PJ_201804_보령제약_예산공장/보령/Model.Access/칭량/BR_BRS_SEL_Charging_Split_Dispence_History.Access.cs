...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_Charging_Split_Dispence_History
    /// </summary>
    public partial class BR_BRS_SEL_Charging_Split_Dispence_History : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _CHGQTY_UOM;
            [BizActorOutputItemAttribute()]
            public string CHGQTY_UOM
            {
                get
                {
                    return this._CHGQTY_UOM;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._CHGQTY_UOM = value;
                        this.CheckIsOriginal("CHGQTY_UOM", value);
                        this.OnPropertyChanged("CHGQTY_UOM");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public System.Nullable<decimal> REQQTY
            {
                ...
                set
                {
                    ...
                    {
                        this._REQQTY = value;
                        this.CheckIsOriginal("REQQTY", value);
                        this.OnPropertyChanged("REQQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_Charging_Split_Dispence_History()
        {
            RuleName = "BR_BRS_SEL_Charging_Split_Dispence_History";
            BizName = "BR_BRS_SEL_Charging_Split_Dispence_History";
