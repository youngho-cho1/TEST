...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_IPC_AVG_WEIGHT_MULTI
    /// </summary>
    public partial class BR_BRS_REG_IPC_AVG_WEIGHT_MULTI : BizActorRuleBase
    {
        ...
        public BR_BRS_REG_IPC_AVG_WEIGHT_MULTI()
        {
            RuleName = "BR_BRS_REG_IPC_AVG_WEIGHT_MULTI";
