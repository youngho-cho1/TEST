...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_UDB_REG_PMS_FILLED_BIN_IN
    /// </summary>
    public partial class BR_UDB_REG_PMS_FILLED_BIN_IN : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _FROM_ROOMID;
            [BizActorInputItemAttribute()]
            public string FROM_ROOMID
            {
                get
                {
                    return this._FROM_ROOMID;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FROM_ROOMID = value;
                        this.CheckIsOriginal("FROM_ROOMID", value);
                        this.OnPropertyChanged("FROM_ROOMID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string TO_STATION
            {
                ...
                set
                {
                    ...
                    {
                        this._TO_STATION = value;
                        this.CheckIsOriginal("TO_STATION", value);
                        this.OnPropertyChanged("TO_STATION");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string ERR_MSG
            {
                ...
                set
                {
                    ...
                    {
                        this._ERR_MSG = value;
                        this.CheckIsOriginal("ERR_MSG", value);
                        this.OnPropertyChanged("ERR_MSG");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_UDB_REG_PMS_FILLED_BIN_IN()
        {
            RuleName = "BR_UDB_REG_PMS_FILLED_BIN_IN";
