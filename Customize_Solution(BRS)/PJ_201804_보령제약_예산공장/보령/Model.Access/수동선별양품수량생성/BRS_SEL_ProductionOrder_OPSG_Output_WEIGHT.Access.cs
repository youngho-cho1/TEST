...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BRS_SEL_ProductionOrder_OPSG_Output_WEIGHT
    /// </summary>
    public partial class BRS_SEL_ProductionOrder_OPSG_Output_WEIGHT : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _OPSGID;
            [BizActorInputItemAttribute()]
            public string OPSGID
            {
                get
                {
                    return this._OPSGID;
                ...
                set
                {
                    ...
                    {
                        this._OPSGID = value;
                        this.CheckIsOriginal("OPSGID", value);
                        this.OnPropertyChanged("OPSGID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            private string _OUTPUT_WEIGHT;
            [BizActorOutputItemAttribute()]
            public string OUTPUT_WEIGHT
            {
                get
                {
                    return this._OUTPUT_WEIGHT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._OUTPUT_WEIGHT = value;
                        this.CheckIsOriginal("OUTPUT_WEIGHT", value);
                        this.OnPropertyChanged("OUTPUT_WEIGHT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _RESULT_WEIGHT;
            [BizActorOutputItemAttribute()]
            public string RESULT_WEIGHT
            {
                get
                {
                    return this._RESULT_WEIGHT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._RESULT_WEIGHT = value;
                        this.CheckIsOriginal("RESULT_WEIGHT", value);
                        this.OnPropertyChanged("RESULT_WEIGHT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
