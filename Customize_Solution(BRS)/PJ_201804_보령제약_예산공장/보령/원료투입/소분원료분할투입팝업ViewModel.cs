...
namespace 보령
{
    public class 소분원료분할투입팝업ViewModel : ViewModelBase
    {
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case enumCheckStep.ComponentChargeChecked:
                        IsBarcodeReaderVisible = Visibility.Visible;
                        Message = string.Format("[{0}] 원료 투입 준비됨. 다음 바코드를 스캔하세요", _currentComponent.MSUBLOTID);
                        break;
        ...
        BR_BRS_SEL_ProductionOrder_Dispence_Component_Summary.OUTDATA _currentComponent;
        ...
        소분원료분할투입ViewModel _parentVM;
        public 소분원료분할투입ViewModel ParentVM
        {
