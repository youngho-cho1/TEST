...
namespace 보령
{
    public class ScaleScanPopupViewModel : ViewModelBase
    {
        #region [Property]

        ScaleScanPopup _ScaleScanPopup;
        enum enumCheckStep
        {
            WaitBarcode,
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case enumCheckStep.ComponentChargeChecked:
                        ...
                        _ScaleScanPopup.DialogResult = true;
                        break;
                    default:
                        break;
                }
        ...
        public ScaleScanPopupViewModel()
        {
            ...
            get
            {
                return new CommandBase(arg =>
                {
                    try
                    {
                        ...
                        ///
                        if (arg != null)
                            _ScaleScanPopup = arg as ScaleScanPopup;
        ...
        async Task<bool> IsMatchedComponent(string barcode)
        {
            ...
            if (ScaleId != null && ScaleId.ToUpper() == barcode.ToUpper())
            {
                ...
                {
                    _ScaleScanPopup.tbBarcode.Focus();
                });
                return false;
            }
            ...
            if (await _BR_PHR_SEL_CurrentWeight.Execute())
            {
                ...
                {
                    ScaleId = barcode;
                    Scale = _BR_PHR_SEL_CurrentWeight.OUTDATAs[0].Weight.ToString() + " " + _BR_PHR_SEL_CurrentWeight.OUTDATAs[0].UOM;
