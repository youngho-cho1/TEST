...
namespace 보령
{
    public class 소분원료확인팝업ViewModel : ViewModelBase
    {
        ...
        BR_PHR_SEL_ProductionOrder_Component_Summary_CHGSEQ.OUTDATA _currentComponent;
        ...
        소분원료확인ViewModel _parentVM;
        public 소분원료확인ViewModel ParentVM
        {
        ...
        async Task<bool> IsMatchedComponent(string barcode)
        {
            ...
            var matchedComponent = ParentVM.FilteredComponents.Where(o => o.MSUBLOTID == scannedComponent.MSUBLOTID).FirstOrDefault();
            ...
            _currentComponent.SCANNED_BARCODE = barcode;
