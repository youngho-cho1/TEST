...
namespace 보령
{
    public class 선별공정수율ViewModel : ViewModelBase
    {
        #region Properties
        ...
        BR_BRS_SEL_Yield_Calculation_Weight_Selection _BR_BRS_SEL_Yield_Calculation_Weight_Selection;
        public BR_BRS_SEL_Yield_Calculation_Weight_Selection BR_BRS_SEL_Yield_Calculation_Weight_Selection
        {
            get { return _BR_BRS_SEL_Yield_Calculation_Weight_Selection; }
            set { _BR_BRS_SEL_Yield_Calculation_Weight_Selection = value; }
        }
                    ...
                    using (await AwaitableLocks["LoadedCommand"].EnterAsync())
                    {
                        try
                        {
                            ...
                            if (arg != null)
                            {
                                ...
                                _BR_BRS_SEL_Yield_Calculation_Weight_Selection.INDATAs.Clear();
                                _BR_BRS_SEL_Yield_Calculation_Weight_Selection.OUTDATAs.Clear();

                                _BR_BRS_SEL_Yield_Calculation_Weight_Selection.INDATAs.Add(new BR_BRS_SEL_Yield_Calculation_Weight_Selection.INDATA()
                                {
                                ...
                                await _BR_BRS_SEL_Yield_Calculation_Weight_Selection.Execute();
                                ...
                                if (_BR_BRS_SEL_Yield_Calculation_Weight_Selection.OUTDATAs.Count > 0)
                                {

                                    Result_IN = _BR_BRS_SEL_Yield_Calculation_Weight_Selection.OUTDATAs[0].IN_VALUE;
                                    Result_OUT = _BR_BRS_SEL_Yield_Calculation_Weight_Selection.OUTDATAs[0].OUT_VALUE;
                                    Result_SUM = _BR_BRS_SEL_Yield_Calculation_Weight_Selection.OUTDATAs[0].SUM.HasValue ? MathExt.Round(_BR_BRS_SEL_Yield_Calculation_Weight_Selection.OUTDATAs[0].SUM.Value, PRECISION, MidpointRounding.AwayFromZero) : 0m;
        ...
        public 선별공정수율ViewModel()
        {
            _BR_BRS_SEL_Yield_Calculation_Weight_Selection = new BR_BRS_SEL_Yield_Calculation_Weight_Selection();
